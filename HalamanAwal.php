...
if (isset($_POST['add_temp'])) {
  ...
  if ($sisa == 0) {
    ...
    $tgl = date('Y-m-d');    
    $query = $mysqli->query("INSERT INTO temp_transaksi_pemesanan  (tgl,id_menu,id_harga,jumlah,total)
...
if (isset($_POST['add'])) {
  ...
  $query = $mysqli->query("INSERT INTO transaksi_pemesanan  (kd_transaksi,tgl,nomer_meja,atas_nama,total,no_hp, pembayaran, reservasi)
  VALUES ('$_POST[kd_transaksi]','$tgl','$_POST[no_meja]','$_POST[atas_nama]','$total','$_POST[no_hp]','$_POST[pembayaran]','$_POST[reservasi]')");
  $id_pemesanan = $mysqli->insert_id;
  for ($i = 0; $i < $jumlah_menu; $i++) {
    ///////////////////perulanagan 
    $masukkan = $mysqli->query("INSERT INTO transaksi_pemesanan_detail (id_pemesanan,id_menu,porsi)
...
<div class="content-wrapper">
  <?php
    $tgl = date('Y-m-d');
    $d = mysqli_fetch_array($mysqli->query("SELECT * FROM buka_tutup WHERE tanggal='$tgl' AND status = '1'"));
    if($d != null){
  ?> 
  <div class="container">
                ...
                <form role="form" method="POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="atas_nama" value="" name="atas_nama">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Kode Pemesanan</label>
                      <input type="text" class="form-control" id="kd_transaksi" value="<?php echo $kd_trans; ?>" name="kd_transaksi" readonly>
                    </div>
                    <div class="form-group">
                      <input class="form-control" id="no_hp" name="no_hp" value="" placeholder="No Handphone" type="text" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Status Reservastion</label>                      
                      <select class="form-control" id="reservasi" name="reservasi">
                        <option value="non_Reservation">Non Reservation</option>
                   ...
                   order by a.tgl asc");
                        ...
                        <tr>
                          ...
                          $liatHarga = mysqli_fetch_array($mysqli->query("SELECT sum(total) as subtotal FROM temp_transaksi_pemesanan where tgl = '$tgl'
